...
//        }
        UserService userService = new UserServiceImpl();
//userService.createUsersTable();
//userService.saveUser("Rahim","Kurbanov",(byte) 18);
//        userService.dropUsersTable();
//   userDao.saveUser("Kutuber","Gaparov", (byte) 12);
//   userDao.saveUser("Rahim","Kurbanov",(byte) 18);
//   userDao.saveUser("Aisuluu","Baatyrov", (byte) 23);
